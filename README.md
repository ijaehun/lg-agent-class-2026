...
- 각 `week*/` 폴더의 `.py` 파일에는 **`# TODO`** 와 **`___`** 빈칸이 있습니다.
- 강의 시간에 강사 안내를 따라 함께 채워나갑니다. 결과는 전원 동일.
- 강의 마지막에는 이 골격 위에서 본인 업무 도구로 변형해보는 단계로 넘어갑니다.

## 강의 끝난 뒤 다시 와도 됩니다

`solutions/` 의 완성본 + 각 `weekN_*/README.md` 만 봐도 흐름을 다시 따라갈 수 있게 짜놨습니다.
막힐 때 언제든 강사에게 연락 주세요.
